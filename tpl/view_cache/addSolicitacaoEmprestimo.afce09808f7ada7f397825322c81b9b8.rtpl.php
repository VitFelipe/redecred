...
<div class="content-wrapper">
  ...
  <ul class="nav nav-tabs" role="tablist">
      ...
      <!-- Tab panes -->
      <form method="POST" action="/crede_cred/admin/solicitacao/enviar" enctype="multipart/form-data">
            ...
            <div class="col-md-6">
                   ...
                   <div class="col-md-4">
                                ...
                                <div class="form-group">
                                        ...
                                        <input type="number" name="especie" id="especie-bene-id"  class="form-control" placeholder="Digite a Especie do BENEFÍCIO">
                                </div>
                   </div>
                   <div class="col-md-4">
                          ...
                          <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                                ...
                                                                <input class="simple-field-data-mask-reverse form-control" required type="text" data-mask="#.###,##" data-mask-reverse="true" data-mask-maxlength="false" name="valor_emprestimo" id="valor-emprestimo-id"    placeholder="Informe o Valor do Emprestimo !">
                                                </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                                ...
                                                                <input class="simple-field-data-mask-reverse form-control" required type="text" data-mask="#.##0,00" data-mask-reverse="true" data-mask-maxlength="false" name="valor_parcela" id="valor-parcela-id"    placeholder="Informe o valor da parcela !">
                                                        </div>
