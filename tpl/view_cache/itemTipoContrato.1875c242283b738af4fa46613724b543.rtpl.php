                    ...
                    <table  class="table table-bordered table-hover table-style">
                      ...
                      <tbody>
                          ...
                          <tr>
                                ...
                                <td> 
                                        <a href="/admin/convenio/itemprazo/<?php echo htmlspecialchars( $value1["item_tipo_contrato_id"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" class="btn btn-success btn-editar-banco" ><span class="fa  fa-search"></span>  Atualizar Prazo</a>                                </td>
