...
<div class="content-wrapper">
    ...
    <section class="content-header">
            ...
            <h1>
                  Convênio <small>Tipo Contrato</small>
           </h1>
           <ol class="breadcrumb">
    ...
    <section class="content">
            ...
            <div class="row">
                    <div class="col-md-12">
                        <a class="btn btn-info" href="/crede_cred/admin/convenio">voltar</a>
                    </div>
                </div>
                    ...
                    <table  class="table table-bordered table-hover table-style">
                      ...
                      <tbody>
                          ...
                          <tr>
                                ...
                                <td> 
                                        <a href="/crede_cred/admin/convenio/itemprazo/<?php echo htmlspecialchars( $value1["item_tipo_contrato_id"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" class="btn btn-success btn-editar-banco" ><span class="fa  fa-search"></span>  Atualizar Prazo</a>                                </td>
