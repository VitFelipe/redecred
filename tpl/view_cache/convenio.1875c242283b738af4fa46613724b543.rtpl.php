      ...
      <tbody>
        ...
        <td> 
         <div class="row">
            ...
            <a href="/admin/convenio/<?php echo htmlspecialchars( $value1["convenio_contrato_id"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/editar" class="btn btn-info btn-editar-banco" ><span class="fa  fa-pencil"></span></a>
            <a href="/admin/convenio/<?php echo htmlspecialchars( $value1["convenio_contrato_id"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/detalhe" class="btn btn-success btn-editar-banco" ><span class="fa  fa-search"></span></a>
        ...
        <div class="modal fade bs-example-modal-lg " tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
              ...
              <!-- Inicio formulario-->
        <form id="formularioBanco" method="post" action="/admin/convenio/create">
            <div class="row">
