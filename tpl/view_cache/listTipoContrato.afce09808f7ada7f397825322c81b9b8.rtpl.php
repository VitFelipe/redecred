    ...
    <div class="box-body">
        ...
        <td> 
         <div class="row">
            ...
            <a class="btn btn-danger " style="margin-left:8px;" href="/crede_cred/admin/tipoContrato/<?php echo htmlspecialchars( $value1["tipo_contrato_id"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/delete" onclick="return confirm('Tem certeza que deseja excluir o tipo Relatorio  <?php echo htmlspecialchars( $value1["descricao"], ENT_COMPAT, 'UTF-8', FALSE ); ?> ?');" ><span class="fa  fa-close"></span></a>
        </div>
        </td>
        </tr>
        <?php } ?>
        ...
        <div class="modal fade bs-example-modal-lg " tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
              ...
              <!-- Inicio formulario-->
        <form  method="post" action="/crede_cred/admin/tipoContrato/create">
            <div class="row">
        ...
        <div class="modal fade modal-editar " tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel2">
                <div class="modal-dialog modal-lg" role="document">
                  ...
                  <div class="modal-content">
                      ...
                      <div class="modal-body">
              <!-- Inicio formulario-->
        <form  method="post" action="/crede_cred/admin/tipoContrato/editar">         
                <div class="row">
