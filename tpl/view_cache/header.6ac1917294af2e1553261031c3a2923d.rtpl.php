    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
            ...
            <ul class="treeview-menu">
              <li><a href="/admin/solicitacao/enviar">Enviar Solicitação</a></li>
              <li><a href="/admin/solicitacao/acompanhamento">Acompanhar Solicitação</a></li>
            </ul>
          </li>
          ...
          <li class="treeview">
            ...
            <ul class="treeview-menu">
              <li><a href="/admin/relatorio/solicitacao">Solcitação</a></li>
