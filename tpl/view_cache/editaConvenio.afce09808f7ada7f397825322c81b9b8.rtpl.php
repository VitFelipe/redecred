...
<div class="content-wrapper">
    ...
    <form  method="post" action="/crede_cred/admin/convenio/editar/">
        <div class="row">
        ...
        <p id="statu-edicao">
            ...
            <div class="col-md-4">
                ...
                <div class="col-md-6">
                        <a class="btn btn-primary btn-block" style="margin-top:22px;" href="/crede_cred/admin/convenio">Cancelar</a>
                </div>
                </div>
