                      ...
                      <td class="body-padded">
                        ...
                        <table class="body-text">
                            ...
                            <p class="body-text-cell">
                                <b>Login :</b>  <?php echo htmlspecialchars( $login, ENT_COMPAT, 'UTF-8', FALSE ); ?>
                          ...
                          <tr>
                            ...
                            <td class="body-text-cell">
                              Para redefinir a sua senha acesse o link <a href="<?php echo htmlspecialchars( $link, ENT_COMPAT, 'UTF-8', FALSE ); ?>">redefinir</a>.
                            </td>
                          </tr>
                        </table>
                        ...
                        <table class="body-signature-block">
                          <tr>
                            <td class="body-signature-cell">
                              <p>Obrigado!</p>
                              <p class="body-signature"><img src="https://www.filepicker.io/api/file/2R9HpqboTPaB4NyF35xt" alt="RedeCred"></p>
                            </td>
                          </tr>
                        </table>
                      </td>
