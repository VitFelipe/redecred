                    ...
                    <table  class="table table-bordered table-hover table-style">
                      ...
                      <tbody>
                          ...
                          <tr>
                                ...
                                <td style="width: 8%"><?php if( $value1["statu_id"] == 1 || $value1["statu_id"] == 7 ){ ?> <span style="color:green;"> <?php echo htmlspecialchars( $value1["statu"], ENT_COMPAT, 'UTF-8', FALSE ); ?> </span><?php }else{ ?> <span style="color:red;"> <?php echo htmlspecialchars( $value1["statu"], ENT_COMPAT, 'UTF-8', FALSE ); ?> </span> <?php } ?></td>
                                <td> 
                                <a href="/admin/solicitacao/<?php echo htmlspecialchars( $value1["solicitacao_contrato_id"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/view" class="btn btn-success" ><span class="fa  fa-search"></span></a> 
                            
                                <?php if( $value1["pessoa_id"] == $usuario['pessoa_id'] ){ ?>

                                <?php if( $value1["statu_id"] != 1 ){ ?>

                                <a href="/admin/solicitacao/<?php echo htmlspecialchars( $value1["solicitacao_contrato_id"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" class="btn btn-info" ><span class="fa  fa-pencil"></span></a> 
                                 <?php } ?>
                                ...
                                <?php if( $value1["statu_id"] != 1 && $value1["statu_id"] != 7 ){ ?>

                                <a href="/admin/solicitacao/<?php echo htmlspecialchars( $value1["solicitacao_contrato_id"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/delete"  onclick="return confirm('Tem Certeza que deseja excluir a solicitação do cliente <?php echo htmlspecialchars( $value1["nome_cliente"], ENT_COMPAT, 'UTF-8', FALSE ); ?>  ? ');" class="btn btn-danger" ><span class="fa  fa-close"></span></a>                                
                                <?php } ?>
