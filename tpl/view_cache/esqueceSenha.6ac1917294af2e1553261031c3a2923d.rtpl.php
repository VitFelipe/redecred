...
<div class="login-box">
  ...
  <div class="login-box-body">
    ...
    <form action="/admin/recuperar/tokken" method="post">
      <div class="form-group has-feedback">
        <input type="email" class="form-control" placeholder="Email" name="email" id="emailId" required="true">
      ...
      <div class="row">
        <div class="col-md-3 ">
          <a href="/admin" class="btn btn-info btn-block btn-flat">Logar</a>
        </div>

       <!--Msg  -->

       <div class="col-md-12">
        <?php if( $msg != null ){ ?>  <?php if( $statu == 0 ){ ?><h5 class="alert alert-danger"><?php echo htmlspecialchars( $msg, ENT_COMPAT, 'UTF-8', FALSE ); ?></h5><?php }else{ ?><h5 class="alert alert-success"><?php echo htmlspecialchars( $msg, ENT_COMPAT, 'UTF-8', FALSE ); ?></h5><?php } ?><?php } ?>
       </div>
