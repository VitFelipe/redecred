...
<div class="content-wrapper">
        ...
        <section class="content">
                ...
                <div class="row">
                        <div class="col-md-12">
                            <a class="btn btn-info" href="/crede_cred/admin/convenio/<?php echo htmlspecialchars( $itens["0"]['convenio_contrato_id'], ENT_COMPAT, 'UTF-8', FALSE ); ?>/detalhe">voltar</a>
                        </div>
                    </div>
            ...
            <div class="row">
                ...
                <div class="box-body">
                    ...
                    <form action="/crede_cred/admin/convenio/itemprazo" class="form-inline" method="POST">
