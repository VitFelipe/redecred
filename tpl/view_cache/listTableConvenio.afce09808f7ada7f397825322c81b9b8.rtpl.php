                    ...
                    <table  class="table table-bordered table-hover table-style">
                      ...
                      <tbody>
                          ...
                          <tr>
                                ...
                                <td> 
                                        <a class="btn btn-info" href="/crede_cred/admin/tabelaConvenio/<?php echo htmlspecialchars( $value1["tabela_convenio_id"], ENT_COMPAT, 'UTF-8', FALSE ); ?>"><span class="fa  fa-pencil"> </span></a>
                                        <a href="/crede_cred/admin/tabelaConvenio/<?php echo htmlspecialchars( $value1["tabela_convenio_id"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/delete" onclick="return confirm('Tem certeza que deseja excluir esse item ?');" class="btn btn-danger"><span class="fa  fa-close"> </span></a>
                                </td>
