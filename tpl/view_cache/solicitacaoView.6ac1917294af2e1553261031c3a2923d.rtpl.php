...
<div class="content-wrapper">
    ...
    <section class="content">
            ...
            <div class="row">
                    <div class="col-md-11">
                        <a class="btn btn-info" href="/admin/solicitacao/acompanhamento">voltar</a>
                    </div>
                    <div class="col-md-1">
                   
                        <label>Exportar</label><a href="/admin/relatorio/solicitacao/view/pdf/<?php echo htmlspecialchars( $solcitacao['solicitacao_contrato_id'], ENT_COMPAT, 'UTF-8', FALSE ); ?>" class="btn btn-info"><span class="fa fa-file-pdf-o"></span></a></li>
                    </div>  
                    <?php if( $usuario['perfil_id'] == 1 ){ ?>

                    <?php if( $solcitacao['status_id'] != 1 && $solcitacao['status_id'] != 7 ){ ?>   
                    <div class="col-md-4">
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <form method="POST" action="/admin/solicitacao/complemento/add" enctype="multipart/form-data" > 
            ...
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  ...
                  <form method="POST" action="/admin/solicitacao/anexo/add" enctype="multipart/form-data" > 
                <input type="hidden" name="solicitacao_id" value="<?php echo htmlspecialchars( $solcitacao["solicitacao_contrato_id"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" />
                <div class="row">
                  <div class="col-md-6 col-md-offset-3">
                    <div class="form-group">
